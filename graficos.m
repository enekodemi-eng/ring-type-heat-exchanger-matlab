%% Gráfica de Tcs, Tfs, T2 y T4 vs kóxido
...
ylabel('T[°C]') % Concepto y unidades
xlabel('kóxido[W/m^2*K]') % Concepto y unidades
title('Gráfica de Tcs, Tfs, T2 y T4 vs kóxido')% Título
legend('Tcs','Tfs','T2','T4')

%% Gráfica de Q vs kóxido
vector_ejex=[2,2.5,3,3.5,4];
...
ylabel('Q[W]') % Concepto y unidades
xlabel('kóxido[W/m^2*K]') % Concepto y unidades
title('Gráfica de Q vs kóxido')% Título

%% Gráfica de reducción de Q vs kóxido
vector_ejex=[2,2.5,3,3.5,4];
vector_ejeyQ=[18.51,15.28,12.98,11.24,9.90];

figure(3)
plot(vector_ejex,vector_ejeyQ,'LineWidth',1)
ylabel('Reducción [%]') % Concepto y unidades
xlabel('kóxido[W/m^2*K]') % Concepto y unidades
title('Gráfica de reducción de Q vs kóxido')% Título
